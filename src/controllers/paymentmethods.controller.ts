...
const updatePaymentMethodSchema = z
  ...
  .refine(
    (data) => data.label !== undefined || data.isActive !== undefined,
    "At least one field (label or isActive) is required",
  );

export const fetchPaymentMethods = async (req: Request, res: Response) => {
  try {
...
export const fetchPaymentMethodById = async (req: Request, res: Response) => {
  try {
